...
class Visit extends Base{
	...
	public function js(){
		...
		return file_put_contents($js,preg_replace('/url : \'.*\',/U','url : \''.Config::get('app.web_url2').Config::get('system.index_php').'common/visit.html\',',file_get_contents($js))) ? $this->success(Config::get('app.prev_url'),'配置更新成功！') : $this->failed('配置更新失败，请检查public/home/js目录权限！');
	}
}