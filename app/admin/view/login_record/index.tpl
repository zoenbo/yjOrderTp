...
{block name="search"}
<form method="get" action="" class="search">搜索：<select name="uid" class="select"><option value="0">查看所有管理员</option>{$Manager}</select> <input type="text" name="keyword" value="{:input('get.keyword')}" class="input-text"><input type="submit" value="搜索" class="btn btn-primary radius"></form>
{/block}
