...
{block name="search"}
<form method="get" action="" class="search layui-form">搜索：<select name="product_sort_id" lay-search><option value="0">查看所有分类</option>{$ProductSort}</select> <input type="text" name="keyword" value="{:input('get.keyword')}" class="input-text"><input type="submit" value="搜索" class="btn btn-primary radius"></form>
{/block}
