...
<form method="post" action="" class="form">
  <table>
    ...
    <tr class="pro1 pid1"><td>选择产品：</td><td><select name="pid1[]" multiple class="select"></select></td><td>可按住ctrl进行多选，生成的下单页只显示勾选且在<a href="javascript:;" onclick="window.parent.addTab('{:url('/product/index')}','产品管理')">产品管理</a>模块中设置了前台显示的产品</td></tr>
