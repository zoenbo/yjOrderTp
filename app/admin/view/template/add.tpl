...
<form method="post" action="" class="form">
  <table>
    ...
    <tr class="pro1 pid1"><td>选择产品：</td><td><select name="pid1[]" multiple class="select"></select></td><td>可按住ctrl进行多选，生成的下单页只显示勾选且在<a href="javascript:;" onclick="addTab('{:url('/product/index')}','产品管理')">产品管理</a>模块中设置了前台显示的产品</td></tr>
    ...
    <tr><td>订单查询：</td><td><div class="radio-box"><label><input type="radio" name="is_show_search" value="0" checked>关闭</label></div><div class="radio-box"><label><input type="radio" name="is_show_search" value="1">开启</label></div></td><td>在<a href="javascript:;" onclick="addTab('{:url('/system/index')}','系统设置')">系统设置</a>模块中开启“订单查询”后，此设置才可生效</td></tr>
