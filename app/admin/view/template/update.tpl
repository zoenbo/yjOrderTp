...
<form method="post" action="" class="form">
  <table>
    ...
    <tr class="pro1 product_ids1"><td>选择产品：</td><td><input type="hidden" name="pro" value="{$One['pro']}"><input type="hidden" name="product_selected" value="{$One['product_selected']}"><select name="product_ids1[]" multiple class="select"></select></td><td>可按住ctrl进行多选，生成的下单页只显示勾选且在<a href="javascript:" onclick="window.parent.addTab('{:url('/product/index')}','产品管理')">产品管理</a>模块中设置了前台显示的产品</td></tr>
