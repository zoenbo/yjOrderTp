...
<table class="tip">
  ...
  <tr><td class="num">3、</td><td>设置参数，以QQ邮箱为例。服务器和端口分别为：smtp.qq.com、25或ssl://smtp.qq.com、465（后者较稳定） | 发信人邮件地址、身份验证用户名均为邮箱地址（注意加@qq.com） | 身份验证密码为邮箱密码（如果是新开通的SMTP服务，开通时会生成一个授权码，身份验证密码为这个授权码）。</td></tr>
</table>
{/block}
