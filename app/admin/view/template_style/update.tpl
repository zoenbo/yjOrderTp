...
<form method="post" action="" class="form layui-form">
  <table>
    <tr><td>背景颜色：</td><td><input type="text" name="bg_color" value="{$One['bg_color']}" class="input-text"></td><td rowspan="4">颜色值可以为：表示颜色的英文单词，如red；16进制的颜色代码，如#FF0000；10进制的颜色代码，如rgb(255,0,0)。</td></tr>
    <tr><td>边框颜色：</td><td><input type="text" name="border_color" value="{$One['border_color']}" class="input-text"></td></tr>
    <tr><td>按钮颜色：</td><td><input type="text" name="button_color" value="{$One['button_color']}" class="input-text"></td></tr>
    <tr><td>下拉框选中背景颜色：</td><td><input type="text" name="select_current_bg_color" value="{$One['select_current_bg_color']}" class="input-text"></td></tr>
