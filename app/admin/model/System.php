...
class System extends Model{
	...
	public function form(){
		...
		if ($validate->check($data)){
			...
			if (Request::post('manage_enter')!=Config::get('system.manage_enter') && is_file(ROOT_PATH.'/'.Request::post('manage_enter'))) return '系统根目录中已存在'.Request::post('manage_enter').'文件，请重新指定一个后台入口！';
			return 1;
		}else{
