...
<script type="text/javascript" src="public/home/js/Tip.js?{:staticCache()}"></script>
<link rel="stylesheet" type="text/css" href="public/home/styles/Tip.css?{:staticCache()}">
</head>

<body>
<div class="tip">
  <p><img src="public/home/images/{$Kind}.png?{:staticCache()}" alt="{$Kind}"></p>
  <p>{$Tip}</p>
