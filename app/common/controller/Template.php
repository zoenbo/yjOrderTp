...
<div class="order">
  <div class="left">
    ...
    <form method="post" action="" target="_parent" class="form">
      <dl class="orderform">
        ...
        <dd>支付方式：<label><input type="radio" name="pay" value="1" checked>货到付款</label> <label><input type="radio" name="pay" value="2">支付宝</label> <label><input type="radio" name="pay" value="6">微信支付</label></dd>
  ...
  <div class="right"><div class="send"></div><div class="list"><div class="list1"></div><div class="list2"></div></div></div>
...
<div class="order">
  ...
  <form method="post" action="" target="_parent" class="form">
    <dl class="orderform">
	  ...
	  <input type="hidden" name="county">
	  <input type="hidden" name="town">
      <dd><span class="left"></span><span class="right"><select class="select province"><option value="0">省份</option></select></span></dd>
      <dd><span class="left"></span><span class="right"><select class="select city"><option value="0">城市</option></select></span></dd>
      <dd><span class="left"></span><span class="right"><select class="select county"><option value="0">区/县</option></select></span></dd>
	  ...
	  <dd><span class="left">区 / 县 ：</span><span class="right"><input type="text" name="county2" class="text"></span></dd>
      ...
      <dd><span class="left">邮政编码：</span><span class="right"><input type="text" name="post" maxlength="6" class="text"></span></dd>
      ...
      <dd class="pay"><span class="left">支付方式：</span><span class="right"><label><input type="radio" name="pay" value="1" checked>货到付款</label> <label><input type="radio" name="pay" value="2">支付宝</label> <label><input type="radio" name="pay" value="6">微信支付</label></span></dd>
...
<div class="tip"></div>
		...
		$output = preg_replace('/<form method="post" action="[\w\W]*"/U','<form method="post" action="'.Config::get('app.web_url').Config::get('system.index_php').'sub_order.html'.'"',$output);
