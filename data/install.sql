...
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('11','订单回收站','Recycle','index','0','0','11');
...
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('20','订单统计','Ostatistic','index','0','0','20');
...
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('25','订单状态','Ostate','index','0','0','25');
...
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('29','设置默认','','selected','0','25','29');
...
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('41','前台显示','','view','0','36','41');
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('42','设置默认','','selected','0','36','42');
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('43','产品分类','Psort','index','0','0','43');
...
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('53','设置默认','','selected','0','48','53');
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('54','获取代码','','code','0','48','54');
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('55','模板样式','Style','index','0','0','55');
...
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('60','设置默认','','selected','0','59','60');
...
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('83','设置默认','','selected','0','79','83');
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('84','权限管理','Permit','index','0','0','84');
INSERT INTO `yjorder_permit`(`id`,`name`,`controller`,`action`,`is_default`,`parent_id`,`sort`) VALUES('85','设置默认','','selected','0','84','85');
