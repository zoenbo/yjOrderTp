...
class QC extends Oauth
{
    ...
    public function __construct($accessToken = '', $openid = '', $callback = '')
    {
    ...
    private function applyAPI($arr, $argsList, $baseUrl)
    {
        $pre = '#';
        ...
        foreach ($optionArgList as $val) {
            ...
            if (!$n) {
                exit('api调用参数错误，' . implode(',', $val) . '必填一个');
            }
        }
    ...
    public function __call($name, $arg)
    {
        ...
        $response = json_decode($this->applyAPI($arg[0], $argsList, $baseUrl));
